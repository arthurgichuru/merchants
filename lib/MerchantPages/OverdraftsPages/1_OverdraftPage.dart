...
class _MokashOverdraftPage extends State<MokashOverdraftPage>{
  ...
  Widget build(BuildContext context) {
    ...
    var loanDial = CircularPercentIndicator(
      ...
      center: Text('KES 50,000', style: TextStyle(fontSize: 20), textAlign: TextAlign.center,),
            ...
            children: <Widget>[
              SizedBox(
                ...
                child: new RaisedButton(
                    child: const Text('ACTIVATE OVERDRAFT', style: TextStyle(color: Colors.white),),
                    elevation: 4.0,
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Overdraft', style: TextStyle(color: Colors.white), ),
          leading: IconButton(
