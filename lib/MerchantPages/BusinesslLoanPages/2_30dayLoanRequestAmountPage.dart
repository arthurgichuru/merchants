...
import 'package:merchants/MerchantPages/BusinesslLoanPages/3_30dayLoanRequestPurposePage.dart';


class ThirtyDayLoanRequestPage extends StatefulWidget{

  _ThirtyDayLoanRequestPage createState()=> _ThirtyDayLoanRequestPage();
}

class _ThirtyDayLoanRequestPage extends State<ThirtyDayLoanRequestPage>{
            ...
            children: <Widget>[
              SizedBox(
                ...
                child: new RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(new MaterialPageRoute(builder: (context)=> ThirtyDayLoanPurposePage()));
                    }),
              ),
            ],
          ),
