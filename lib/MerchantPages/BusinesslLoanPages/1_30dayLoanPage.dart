...
import 'package:merchants/MerchantPages/BusinesslLoanPages/2_30dayLoanRequestAmountPage.dart';
    ...
    final descriptionText = new Column(
        ...
        children: <Widget>[
          SizedBox(
            width: 250.0,
            height: 50.0,
            child: new Text('You are eligible for a 1 - 3 month personal loan of up to:',
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('1 - 3 month Loan', style: TextStyle(color: Colors.white), ),
          leading: IconButton(
